...
def main() -> None:
    ...
    train_loader, val_loader, _ = datamodule.get_loaders()
    ...
    if cfg.get("diffusion", {}).get("use", False):
        ...
        if manifest_path.exists():
            ...
            train_dataset = augmenter.wrap(train_loader.dataset)
    ...
    trainer.fit(train_loader, val_loader, start_epoch=start_epoch, epochs=cfg["train"]["epochs"])
